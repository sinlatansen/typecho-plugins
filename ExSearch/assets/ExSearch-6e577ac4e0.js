...
!(function (i, c) {
        ...
        return i("<div>")
            ...
            .append(
                i("<div>")
                    ...
                    .append(null != e && "" != e ? e : c.TRANSLATION.UNTITLED)
                    .append(t ? i("<span>").addClass("ins-slug").text(t) : null)
            )
            .append(a ? i("<p>").addClass("ins-search-preview").html(a) : null)
            .attr("data-url", r);
    }
    function a(n, e, t) {
        var a,
        ...
        i("<section>")
            ...
            .append(i("<div>").addClass("ins-section-header").text(o))).append(
            r
        );
    }
    function u(n, e) {
    ...
    t.parent().remove(".ins-search"),
        i("body").append(t),
        i.getJSON(c.CONTENT_URL, function (e) {
            "#ins-search" === location.hash.trim() &&
                (t.addClass("show"), ModalHelper.beforeModal()),
                n.on("input", function () {
                    var n = i(this).val();
                    !(function (n, e) {
                        for (var t in (o.empty(), e))
                            o.append(a(n, t.toUpperCase(), e[t]));
                    })(n, s(e, n));
                }),
                n.trigger("input");
        }),
