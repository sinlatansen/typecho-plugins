...
/**
 * 文章部分加密<br>本插件由<a href="https://www.typecho.wiki/" target="_blank" rel="noopener noreferrer">Typecho.wiki</a>负责分发<br><a href="https://www.typecho.wiki/typecho-plugin-partiallypassword.html" target="_blank" style="background: #000;padding: 2px 4px;color: #ffeb00;font-size: 12px;" rel="noopener noreferrer">使用说明</a> - <a href="https://www.typecho.wiki/typecho-plugin-partiallypassword.html#comments" target="_blank" style="background: #000;padding: 2px 4px;color: #ffeb00;font-size: 12px;" rel="noopener noreferrer">Bug反馈</a> - <a href="https://ucw.moe" target="_blank" style="background: #b94a48;padding: 2px 4px;color: #ffffff;font-size: 12px;" rel="noopener noreferrer">作者网站</a> - <a href="https://www.typecho.wiki/category/plugins/" target="_blank" style="background: #000;padding: 2px 4px;color: #ffeb00;font-size: 12px;" rel="noopener noreferrer">更多Typecho插件</a>
 *
 *
