(function (R, W) {
  typeof exports == "object" && typeof module == "object"
    ...
    ? define("SakanaWidget", [], W)
    : typeof exports == "object"
    ? (exports.SakanaWidget = W())
    : (R.SakanaWidget = W());
})(self, () =>
  (() => {
    "use strict";
    var et = {
        ...
        379: (p) => {
          ...
          function f(n, c) {
            for (var d = {}, b = [], V = 0; V < n.length; V++) {
              var w = n[V],
                S = c.base ? w[0] + c.base : w[0],
                x = d[S] || 0,
                v = "".concat(S, " ").concat(x);
              d[S] = x + 1;
              var E = u(v),
              ...
              if (E !== -1) h[E].references++, h[E].updater(D);
                ...
                var Y = l(D, c);
                (c.byIndex = V),
                  h.splice(V, 0, { identifier: v, updater: Y, references: 1 });
              }
              b.push(v);
            }
            return b;
          ...
          p.exports = function (n, c) {
            ...
            return function (V) {
              ...
              for (var v = f(V, c), E = 0; E < d.length; E++) {
                var D = d[E],
                  Y = u(D);
...
/*# sourceMappingURL=data:application/json;base64,`.concat(
    ...
    function W(p) {
      ...
      var u = (R[p] = { id: p, exports: {} });
      return et[p](u, u.exports, W), u.exports;
    }
    (W.n = (p) => {
      ...
      (W.o = (p, h) => Object.prototype.hasOwnProperty.call(p, h)),
      (W.nc = void 0);
    var Z = {};
    return (
      (() => {
        ...
        var K = function (r) {
          ...
          at = /auto|scroll/,
          Et = /^tb|vertical/,
          Lt = /msie|trident/i.test(J.navigator && J.navigator.userAgent),
          A = function (r) {
          ...
          ct = function (r, t) {
            if ((t === void 0 && (t = !1), q.has(r) && !t)) return q.get(r);
            if (it(r)) return q.set(r, ot), ot;
            var e = getComputedStyle(r),
              s = X(r) && r.ownerSVGElement && r.getBBox(),
              i = !Lt && e.boxSizing === "border-box",
              a = Et.test(e.writingMode || ""),
              o = !s && at.test(e.overflowY || ""),
              m = !s && at.test(e.overflowX || ""),
              g = s ? 0 : A(e.paddingTop),
              C = s ? 0 : A(e.paddingRight),
              y = s ? 0 : A(e.paddingBottom),
              F = s ? 0 : A(e.paddingLeft),
              I = s ? 0 : A(e.borderTopWidth),
              $t = s ? 0 : A(e.borderRightWidth),
              te = s ? 0 : A(e.borderBottomWidth),
              ee = s ? 0 : A(e.borderLeftWidth),
              ft = F + C,
              wt = g + y,
              $ = ee + $t,
              tt = I + te,
              yt = m ? r.offsetHeight - tt - r.clientHeight : 0,
              Ft = o ? r.offsetWidth - $ - r.clientWidth : 0,
              re = i ? ft + $ : 0,
              se = i ? wt + tt : 0,
              T = s ? s.width : A(e.width) - re - Ft,
              P = s ? s.height : A(e.height) - se - yt,
              ie = T + ft + Ft + $,
              ne = P + wt + yt + tt,
              Vt = K({
                devicePixelContentBoxSize: B(
                ...
                borderBoxSize: B(ie, ne, a),
                contentBoxSize: B(T, P, a),
                contentRect: new st(F, g, T, P),
              });
            return q.set(r, Vt), Vt;
          },
          ht = function (r, t, e) {
            var s = ct(r, e),
              i = s.borderBoxSize,
          ...
          Kt = (function () {
            function r(t) {
              ...
              (this.target = t),
                ...
                (this.borderBoxSize = K([e.borderBoxSize])),
                (this.contentBoxSize = K([e.contentBoxSize])),
                (this.devicePixelContentBoxSize = K([
            ...
            Y.forEach(function (o) {
              if (o.activeTargets.length !== 0) {
                ...
                o.activeTargets.forEach(function (C) {
                  ...
                  t.push(function () {
                    o.callback.call(o.observer, m, o.observer);
                  }),
          ...
          qt = (function () {
            ...
            return (
              ...
              (r.prototype.observe = function () {
                var t = this,
                  e = function () {
                    return t.observer && t.observer.observe(document.body, Zt);
                  };
                document.body ? e() : J.addEventListener("DOMContentLoaded", e);
              }),
              (r.prototype.start = function () {
                ...
                this.stopped &&
                  ...
                  pt.forEach(function (e) {
                    return J.addEventListener(e, t.listener, !0);
                  }));
              }),
              (r.prototype.stop = function () {
                ...
                this.stopped ||
                  ...
                  pt.forEach(function (e) {
                    return J.removeEventListener(e, t.listener, !0);
                  }),
                  (this.stopped = !0));
              }),
              r
          ...
          j = new qt(),
          gt = function (r) {
            !M && r > 0 && j.start(), (M += r), !M && j.stop();
          },
          Mt = function (r) {
            return !X(r) && !At(r) && getComputedStyle(r).display === "inline";
          },
          Nt = (function () {
            function r(t, e) {
              (this.target = t),
            ...
            return (
              (r.prototype.isActive = function () {
                ...
                return (
                  Mt(this.target) && (this.lastReportedSize = t),
          ...
          U = (function () {
            ...
            return (
              ...
              (r.observe = function (t, e, s) {
                ...
                Wt(i.observationTargets, e) < 0 &&
                  (a && Y.push(i),
                  i.observationTargets.push(new Nt(e, s && s.box)),
                  gt(1),
                  j.schedule());
              }),
              (r.unobserve = function (t, e) {
                var s = N.get(t),
                  i = Wt(s.observationTargets, e),
          ...
          constructor(r = {}) {
            (this._lastRunUnix = Date.now()),
              ...
              (this._updateSize = (t) => {
                ...
                const e = Ht(this._domCanvas, this._canvasSize);
              ...
              (this._updateDom = () => {
                ...
                const m = "sakana-widget-ctrl-item",
                ...
                (y.className = m),
                  (y.href = "//github.com/dsrkafuu/sakana-widget"),
                  (y.target = "_blank"),
                  (y.innerHTML = Tt),
                  o.appendChild(y);
                ...
                (F.className = m),
                  (F.innerHTML = Gt),
                  (this._domCtrlClose = F),
                  o.appendChild(F);
              }),
              (this._calcCenterPoint = (t, e, s, i) => {
              ...
              (this._draw = () => {
                ...
                (o.style.transform = `rotate(${t}deg) translateX(${C}px) translateY(${e}px)`),
                  g.clearRect(0, 0, this._canvasSize, this._canvasSize),
                  g.save(),
                  g.translate(
                    this._canvasSize / 2,
                    s + (this._canvasSize - s) / 2
                  ),
                ...
                const y = s - m / 2,
                  { nx: F, ny: I } = this._calcCenterPoint(t, y, C, e);
                g.lineTo(F, -I), g.stroke(), g.restore();
              }),
              (this._run = () => {
                ...
                const { d: m, i: g } = this._state,
                  C = Date.now();
                let y = g;
                const F = C - this._lastRunUnix;
                if (
                  (F < 16 && (y = (g / this._frameUnix) * F),
                  (this._lastRunUnix = C),
                  (o = o - s * 2 - t),
                  (s = s + o * y * 1.2),
                  (this._state.w = o * m),
              ...
              (this._onMouseDown = (t) => {
                ...
                const i = (o) => {
                    const m = this._domMain.getBoundingClientRect(),
                      g = m.left + m.width / 2,
                      { pageX: C, pageY: y } = o,
                      F = C - g,
                      I = y - s;
              ...
              (this.nextCharacter = () => {
                const t = Object.keys(Ct.getCharacters()).sort(),
              ...
              (this.mount = (t) => {
                let e = null;
                if (
                  (typeof t == "string" && (e = document.querySelector(t)), !e)
                )
              ...
              (this._options = L(jt)),
              (this._options = _(this._options, r)),
        ...
        (G.getCharacter = (r) => {
          ...
          (G.getCharacters = () => L(O)),
          (G.registerCharacter = (r, t) => {
            const e = L(t);
            let s = e.initialState.i;
